...
class Sim10kDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, data_dir, split, transform=None, target_transform=None, keep_difficult=False):
        ...
        self.class_dict = {class_name: i for i, class_name in enumerate(Sim10kDataset.class_names)}
    ...
    def _read_image_ids(self,image_sets_file):
        ...
        with open(image_sets_file) as f:
            for line in f:
                b, l, _ = self._get_annotation(line.rstrip())
    ...
    def _get_annotation(self, image_id):
        ...
        for obj in objects:
            ...
            if class_name not in Sim10kDataset.class_names:
                continue
