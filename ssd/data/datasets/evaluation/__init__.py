from ssd.data.datasets import VOCDataset, COCODataset, SBBDataset, CityscapesDataset, Sim10kDataset
...
def evaluate(dataset, predictions, output_dir, **kwargs):
    ...
    if isinstance(dataset, VOCDataset) or isinstance(dataset, tuple([SBBDataset,Sim10kDataset])):
        return voc_evaluation(**args)
    elif isinstance(dataset, tuple([COCODataset,CityscapesDataset])):
